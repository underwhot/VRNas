(() => {
    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            spollerTitle.parentNode.classList.toggle("_spoller-parent");
                ...
                function hideSpollersBody(spollersBlock) {
                    ...
                    if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                        spollerActiveTitle.parentNode.classList.remove("_spoller-parent");
        ...
        function initSliders() {
            if (document.querySelector(".slider-articles__slider")) new core(".slider-articles__slider", {
                ...
                pagination: {
                    el: ".slider-articles__pagination",
                    clickable: true
                },
                on: {}
            });
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            ...
            videos.forEach((function(item) {
                item.addEventListener("click", (function() {
                    ...
                    item.insertAdjacentHTML("afterbegin", '<iframe src="https://www.youtube.com/embed/' + videoSrc + '?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
                }));
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
